          ...
          <div className="max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div 
                ...
                className={`transition-all duration-700 ease-in-out rounded-2xl overflow-hidden ${
                  activeIndex === index 
                    ? 'opacity-100 scale-100 z-10' 
                    : 'opacity-0 scale-95 absolute inset-0 z-0 pointer-events-none'
                }`}
              >
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-8 rounded-2xl shadow-lg">
                  <div className="flex justify-center mb-6">
                    <Quote size={48} className="text-blue-400 dark:text-blue-300 opacity-20" />
                  </div>

                  <div className="text-center">
                    <p className="text-xl md:text-2xl font-light italic text-gray-700 dark:text-gray-200 leading-relaxed mb-8">
                      "{testimonial.quote}"
                    </p>
                  </div>
                  ...
                  <div className="mt-6 text-center">
                    <span className="inline-block text-sm text-gray-500 dark:text-gray-400 px-3 py-1 bg-white dark:bg-gray-800 rounded-full">
